...
public class UserController {
    ...
    public String signUp(UserCreateDto dto,@RequestParam(name = "userid")String userid) {//,@RequestParam(name = "userid")String userid
        log.debug("POST signUp({})", dto);
        
        userService.create(dto); //회원가입 정보 insert됨
        
        log.debug("POST signUp({})", userid);
        userService.selectId(userid);
